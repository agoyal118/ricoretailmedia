  ...
  return (
    <svg viewBox="0 0 24 24" aria-hidden="true" {...props}>
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.761 0 5-2.239 5-5v-14c0-2.761-2.239-5-5-5zm-11.882 19.93h-3.229v-9.691h3.229v9.691zm-1.615-11.077c-1.031 0-1.865-.836-1.865-1.865s.834-1.865 1.865-1.865 1.865.834 1.865 1.865-.834 1.865-1.865 1.865zm13.497 11.077h-3.229v-5.059c0-1.205-.027-2.755-1.679-2.755-1.678 0-1.935 1.312-1.935 2.667v5.148h-3.228v-9.691h3.105v1.323h.045c.433-.823 1.492-1.691 3.073-1.691 3.287 0 3.894 2.164 3.894 4.979v5.08z"
      />
    </svg>
  )
}
...
export const socialMediaProfiles = [
  {
    title: 'LinkedIn',
    href: 'https://www.linkedin.com/in/enrico-mirabelli-4826729a/',
    icon: LinkedInIcon,
  },
]
