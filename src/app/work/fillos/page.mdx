...
import imageHero from './Fillos.png'
...
export const caseStudy = {
  ...
  testimonial: {
    author: { name: 'Daniel Caballero', role: 'CEO of Fillos' },
    content:
      'Working with Rico Retail, we felt more like a partner than a customer. They really resonated with our mission to change the way people convince their parents to cash out their pensions.',
  },
}
...
>
  Working with Rico Retail, we felt more like a partner than a customer. They
